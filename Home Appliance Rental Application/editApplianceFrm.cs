...
{
    public partial class editApplianceFrm : Form
    {
        public editApplianceFrm()
        {
            InitializeComponent();
        }
        ...
        public editApplianceFrm(appliancesFrm appliancesFrmRefresh)
        {
            this.appliancesFrm = appliancesFrmRefresh;
        }


        private void editApplianceFrm_Load(object sender, EventArgs e)
        {

            typeCbx.SelectedIndex = appliancesFrm.typeSelectedIndex;
            brandCbx.SelectedIndex = appliancesFrm.brandSelectedIndex;

            modelTxt.Text = appliancesFrm.applianceModel;
            sizeTxt.Text = appliancesFrm.applianceSize;
            colourTxt.Text = appliancesFrm.applianceColour;
            monthlyRentalPriceTxt.Text = appliancesFrm.applianceMonthlyRentalPrice;
            energyConsumptionTxt.Text = appliancesFrm.applianceEnergyConsumption;

            stockUpDown.Text = appliancesFrm.applianceStock;
        ...
        private void addApplianceBtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd = new SqlCommand("UPDATE appliance SET type = '" + typeCbx.Text + "', brand = '" + brandCbx.Text + "', model = '" + modelTxt.Text + "', size = '" + sizeTxt.Text + "', colour = '" + colourTxt.Text + "', energy_consumption = " + energyConsumptionTxt.Text + ", stock = " + stockUpDown.Value.ToString() + ", monthly_rental_fee = " + monthlyRentalPriceTxt.Text + " WHERE Id = " + appliancesFrm.applianceID , con);
                ...
                MessageBox.Show("The appliance has been updated successully", "Home Appliance Rental System", MessageBoxButtons.OK, MessageBoxIcon.Information);
